...
OUTPUT_FILE = PROJECT_ROOT / "data" / "raw" / "excel" / "MASTER_ECONOMETRIA_LATAM_2026.xlsx"

# Mapeo de Responsables y Colores
RESPONSABLES = {
    "Erick Condoy": {
        "variables": ['gei_total_exclulucf_MtCO2e', 'renew_cons_pct_tfec', 'wgi_va_est', 'wgi_ge_est'],
        "color": "#DCE6F1" # Azul claro
    },
    "Marvin Valdivieso": {
        "variables": ['informalidad', 'tecnologia', 'calidad_institucional', 'gobernanza'],
        "color": "#EBF1DE" # Verde claro
    },
    "Abel Espinosa": {
        "variables": ['indice_riesgo_climatico', 'PIBpc', 'renta_rec_nat', 'impuestos_ambientales', 'protec_der_lab', 'climate_altering_land_index'],
    ...
    "Banco Mundial / APE1": {
        "variables": [
            'forest_area_km2', 'ghg_total_incl_lulucf_mt_co2e', 'gdp_per_capita_const2015_usd', 
            'trade_pct_gdp', 'fdi_inflows_pct_gdp', 'renewable_energy_pct_final_energy', 
            'domestic_credit_private_pct_gdp', 'wgi_voice_accountability_est', 'co2_emissions_kt'
        ],
