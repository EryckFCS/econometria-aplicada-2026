...
Una vez confirmada la cointegración entre las variables del IESS, se estiman los coeficientes dinámicos de corto y largo plazo empleando la especificación de corrección de error del modelo ARDL, de acuerdo con el soporte algorítmico de **Sebastian Kripfganz y Daniel Schneider (2023)**.

Para lidiar con no linealidades y quiebres regulatorios extremos que distorsionan los estimadores paramétricos, aplico la validación no paramétrica robusta **Kernel-based Regularized Least Squares (KRLS)** de **Jens Hainmueller y Chad Hazlett (2014)**. En Stata, se utiliza el paquete `krls` de Jeremy Ferwerda y Chad Hazlett (Ferwerda & Hazlett, 2013), modelando la función predictiva mediante:
