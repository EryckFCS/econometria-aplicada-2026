...
Donde $\varphi_{t\tau}$ es una variable dicotómica de quiebre de régimen.
...
Donde $K(x, x_i) = \exp\left( -\frac{\|x - x_i\|^2}{\sigma^2} \right)$ es un kernel gaussiano que mapea interacciones no lineales de alta dimensión y estima efectos marginales locales para cada observación sin supuestos distributivos.
