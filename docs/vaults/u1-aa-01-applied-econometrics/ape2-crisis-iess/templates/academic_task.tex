...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\IfFileExists{assets/logos/logo_unl.png}{\includegraphics[height=1.2cm]{assets/logos/logo_unl.png}}{}}
\fancyhead[R]{\IfFileExists{assets/logos/logo_economia.jpg}{\includegraphics[height=1.2cm]{assets/logos/logo_economia.jpg}}{}}
...
\noindent {\bfseries Estudiante:} $author$ \\
\noindent {\bfseries Docente:} $professor$ \\
\noindent {\bfseries Fecha:} $submission_date$ \\
