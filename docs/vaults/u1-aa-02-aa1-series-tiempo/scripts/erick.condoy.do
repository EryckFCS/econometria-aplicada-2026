...
* 5. SELECCIÓN DE REZAGOS Y CAUSALIDAD (MODELOS DINÁMICOS)
...
* 6. ESTIMACIÓN DE MODELOS DINÁMICOS (SÍLABO)
display "===================================================="
...
* 7. TABLA COMPARATIVA FINAL (MODELOS DINÁMICOS)
display _newline(2) ">>> TABLA FINAL: COMPARACIÓN DE MODELOS DINÁMICOS <<<"
estimates table m1 m2 m3 m4, b(%9.4f) star(0.1 0.05 0.01) stats(N r2 r2_a)
