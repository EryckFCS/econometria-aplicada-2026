...
def interpolate_series(df_annual, target_df_quarterly, col_name):
    ...
    target_years = target_df_quarterly['anio'] + (target_df_quarterly['trimestre'] - 1) / 4
    return f(target_years)

cols_to_interp = ['remesas_pib', 'matricula_superior', 'embi_ecuador', 'gender_participation_gap']
...
exog_vars_2 = ['ln_dependencia', 'ln_subempleo', 'ln_wti', 'ln_embi', 'ln_remesas', 'ln_matricula', 'ln_brecha']
